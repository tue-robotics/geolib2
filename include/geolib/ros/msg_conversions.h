...
/**
 * @brief converting geo::Vector3 to geometry_msgs::msg::Point message
...
/**
 * @brief converting geo::Vector3 to geometry_msgs::msg::Point32 message
 * @param v geo::Vector3 as input
...
/**
 * @brief converting geo::Vector3 to geometry_msgs::msg::Vector3 message
 * @param v geo::Vector3 as input
...
/**
 * @brief converting geo::Quaternion to geometry_msgs::msg::Quaternion
...
/**
 * @brief converting geo::Matrix3 to geometry_msgs::msg::Quaternion
...
/**
 * @brief converting geo::Transform to geometry_msgs::msg::Pose
...
/**
 * @brief converting geo::Transform to geometry_msgs::msg::Transform
 * @param t geo::Transform as input
...
/**
 * @brief converting geo::TraingleI (Indices of a triangle in a vector of points) to shape_msgs::msg::MeshTriangle
...
/**
 * @brief converts a geo::Mesh to shape_msgs::msg::Mesh
 * Both use a very similar structure based on points and triangles.
 * @param m geo::Mesh as input
 * @param msg filled shape_msgs::msg::Mesh message as output
 */
...
/**
 * @brief converting geometry_msgs::msg::Point to geo::Vector3
...
/**
 * @brief converting geometry_msgs::msg::Point32 to geo::Vector3
 * @param msg geometry_msgs::msg::Point as input
 * @param v geo::Vector3 as output
 */
...
/**
 * @brief converting geometry_msgs::msg::Vector3 to geo::Vector3
...
/**
 * @brief converting geometry_msgs::msg::Quaternion to geo::Quaternion
...
/**
 * @brief converting geometry_msgs::msg::Quaternion to geo::Matrix3
 * @param msg geometry_msgs::msg::Quaternion as input
...
/**
 * @brief converting geometry_msgs::msg::Pose to geo::Transform
...
/**
 * @brief converting geometry_msgs::msg::Transform to geo::Transform
