...
public:
    ...
    Vector3(const real* v) { memcpy(v_, v, 3 * sizeof(real)); }
    ...
    inline real length() const { return sqrt(v_[0] * v_[0] + v_[1] * v_[1] + v_[2] * v_[2]); }

    inline real length2() const { return v_[0] * v_[0] + v_[1] * v_[1] + v_[2] * v_[2]; }
    ...
    inline real dot(const Vector3& v) const { return v_[0] * v.v_[0] + v_[1] * v.v_[1] + v_[2] * v.v_[2]; }
    ...
    inline Vector3 operator*(real f) const { return Vector3(v_[0] * f, v_[1] * f, v_[2] * f); }
    ...
    friend Vector3 operator-(const Vector3& v) { return Vector3(-v.v_[0], -v.v_[1], -v.v_[2]); }
...
public:
    ...
    Matrix3x3(const real* m) { memcpy(m_, m, 9 * sizeof(real)); }
    ...
    void setRPY(real roll, real pitch, real yaw)
    {
        ...
        m_[2] = sj * cc + ss;
        m_[3] = cj * sh;
        m_[4] = sj * ss + cc, m_[5] = sj * cs - sc;
        m_[6] = -sj;
        m_[7] = cj * si;
        m_[8] = cj * ci;
    }

    inline Vector3 getRow(int i) { return Vector3(m_[i * 3], m_[i * 3 + 1], m_[i * 3 + 2]); }

    Matrix3x3 operator*(const Matrix3x3& n) const
    {
        return Matrix3x3(m_[0] * n.m_[0] + m_[1] * n.m_[3] + m_[2] * n.m_[6],
                         m_[0] * n.m_[1] + m_[1] * n.m_[4] + m_[2] * n.m_[7],
                         m_[0] * n.m_[2] + m_[1] * n.m_[5] + m_[2] * n.m_[8],
                         m_[3] * n.m_[0] + m_[4] * n.m_[3] + m_[5] * n.m_[6],
                         m_[3] * n.m_[1] + m_[4] * n.m_[4] + m_[5] * n.m_[7],
                         m_[3] * n.m_[2] + m_[4] * n.m_[5] + m_[5] * n.m_[8],
                         m_[6] * n.m_[0] + m_[7] * n.m_[3] + m_[8] * n.m_[6],
                         m_[6] * n.m_[1] + m_[7] * n.m_[4] + m_[8] * n.m_[7],
                         m_[6] * n.m_[2] + m_[7] * n.m_[5] + m_[8] * n.m_[8]);
    }
...
public:
    ...
    {
        return Transform(r_[0] * t.r_[0] + r_[1] * t.r_[3] + r_[2] * t.r_[6],
                         r_[0] * t.r_[1] + r_[1] * t.r_[4] + r_[2] * t.r_[7],
                         r_[0] * t.r_[2] + r_[1] * t.r_[5] + r_[2] * t.r_[8],
                         r_[3] * t.r_[0] + r_[4] * t.r_[3] + r_[5] * t.r_[6],
                         r_[3] * t.r_[1] + r_[4] * t.r_[4] + r_[5] * t.r_[7],
                         r_[3] * t.r_[2] + r_[4] * t.r_[5] + r_[5] * t.r_[8],
                         r_[6] * t.r_[0] + r_[7] * t.r_[3] + r_[8] * t.r_[6],
                         r_[6] * t.r_[1] + r_[7] * t.r_[4] + r_[8] * t.r_[7],
                         r_[6] * t.r_[2] + r_[7] * t.r_[5] + r_[8] * t.r_[8],
    ...
    inline Vector3 getOrigin() const { return Vector3(o_); }

    inline Matrix3x3 getBasis() const { return Matrix3x3(r_); }

    inline Transform inverse() const
    {
        return Transform(r_[0],
                         r_[3],
                         r_[6],
                         r_[1],
                         r_[4],
