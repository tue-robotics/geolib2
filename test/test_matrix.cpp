...
tf2::Transform randomTransform() {
  ...
  return tf2::Transform(
      b, tf2::Vector3(random(-10, 10), random(-10, 10), random(-10, 10)));
}
...
bool equals(double a, double b) { return std::abs(a - b) < 1e-10; }
...
bool equals(const geo::Transform3 &T, const tf2::Transform &T_tf) {
  ...
  if (!equals(q.x, q_tf.getX()) || !equals(q.y, q_tf.getY()) ||
      !equals(q.z, q_tf.getZ()) || !equals(q.w, q_tf.getW())) {
    return false;
  }
...
int main() {
  ...
  if (!equals(t1, t1_tf, "equals(Transform, Transform)") ||
      ...
      !equals(t1.inverse() * t2, t1_tf.inverse() * t2_tf,
              "Transform.inverse() * Transform") ||
      !equals(t1.inverseTimes(t2), t1_tf.inverseTimes(t2_tf),
              "Transform.inverseTimes(Transform)") ||
      !equals(geo::Transform3::identity() * t1, t1_tf,
