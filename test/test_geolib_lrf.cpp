...
std::vector<cv::Point2i> getObjectCornerPoints(
    unsigned int x0, unsigned int y0, double x_obj, double y_obj, double L, double W, double obj_yaw, double pix_per_m)
{
