...
int main(int argc, char **argv) {
    ...
    geo::DepthCamera cam(
        CANVAS_WIDTH, CANVAS_HEIGHT, 554.2559327880068 * CANVAS_WIDTH / 640,
        554.2559327880068 * CANVAS_HEIGHT / 480, 320.5 * CANVAS_WIDTH / 640,
        240.5 * CANVAS_HEIGHT / 480, 0, 0);
    ...
    while (true) {
        ...
        cv::Mat depth_image =
            cv::Mat(CANVAS_HEIGHT, CANVAS_WIDTH, CV_32FC1, 0.0);
        cam.rasterize(*shape, geo::Pose3D(0, 0, 0, 1.57, 0, -1.57), pose,
                      depth_image);
